...
TARGET_TRIPLE="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_TARGET:-x86_64-unknown-linux-musl}"
REMOTE_DIR="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_REMOTE_DIR:-}"
BIND_ADDR="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_BIND_ADDR:-0.0.0.0:44044}"
TLS_CERT_PATH="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_TLS_CERT_PATH:-}"
TLS_KEY_PATH="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_TLS_KEY_PATH:-}"
HEALTH_URL="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_HEALTH_URL:-}"
DASHBOARD_URL="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_DASHBOARD_URL:-}"
TLS_SERVER_NAME="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_TLS_SERVER_NAME:-}"
STOP_TIMEOUT_SECS="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_STOP_TIMEOUT_SECS:-20}"
AUTO_ADD_TARGET="${BERRYKEEP_STATS_COLLECTOR_DEPLOY_AUTO_ADD_TARGET:-true}"
...
REMOTE
  ...
  if ! grep -Fq '<title>BerryKeep Fleet Reliability</title>' <<<"${dashboard_body}"; then
