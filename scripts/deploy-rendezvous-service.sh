...
REMOTE_DIR="${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_DIR:-${BERRYKEEP_RENDEZVOUS_REMOTE_DIR:-}}"
REMOTE_BINARY="${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_BINARY:-${BERRYKEEP_RENDEZVOUS_REMOTE_BINARY:-}}"
LEGACY_REMOTE_BINARY="${BERRYKEEP_RENDEZVOUS_DEPLOY_LEGACY_REMOTE_BINARY:-}"
LEGACY_REMOTE_BINARY_IS_EXPLICIT=0
if [[ -n "${BERRYKEEP_RENDEZVOUS_DEPLOY_LEGACY_REMOTE_BINARY:-}" ]]; then
  LEGACY_REMOTE_BINARY_IS_EXPLICIT=1
fi
REMOTE_WORKDIR="${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_WORKDIR:-${BERRYKEEP_RENDEZVOUS_REMOTE_WORKDIR:-}}"
REMOTE_PIDFILE="${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_PIDFILE:-${BERRYKEEP_RENDEZVOUS_REMOTE_PIDFILE:-}}"
LEGACY_REMOTE_PIDFILE="${BERRYKEEP_RENDEZVOUS_DEPLOY_LEGACY_REMOTE_PIDFILE:-}"
LEGACY_REMOTE_PIDFILE_IS_EXPLICIT=0
if [[ -n "${BERRYKEEP_RENDEZVOUS_DEPLOY_LEGACY_REMOTE_PIDFILE:-}" ]]; then
  LEGACY_REMOTE_PIDFILE_IS_EXPLICIT=1
fi
REMOTE_LOGFILE="${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_LOGFILE:-${BERRYKEEP_RENDEZVOUS_REMOTE_LOGFILE:-}}"
REMOTE_START_CMD="${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_START_CMD:-${BERRYKEEP_RENDEZVOUS_REMOTE_START_CMD:-}}"
REMOTE_MATCH_PATTERN="${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_MATCH_PATTERN:-${BERRYKEEP_RENDEZVOUS_REMOTE_MATCH_PATTERN:-}}"
REMOTE_MATCH_PATTERN_IS_EXPLICIT=0
if [[ -n "${BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_MATCH_PATTERN:-}" || -n "${BERRYKEEP_RENDEZVOUS_REMOTE_MATCH_PATTERN:-}" ]]; then
  REMOTE_MATCH_PATTERN_IS_EXPLICIT=1
fi
STOP_TIMEOUT_SECS="${BERRYKEEP_RENDEZVOUS_DEPLOY_STOP_TIMEOUT_SECS:-${BERRYKEEP_RENDEZVOUS_STOP_TIMEOUT_SECS:-20}}"
FORCE_KILL="${BERRYKEEP_RENDEZVOUS_DEPLOY_FORCE_KILL:-${BERRYKEEP_RENDEZVOUS_FORCE_KILL:-true}}"
AUTO_ADD_TARGET="${BERRYKEEP_RENDEZVOUS_DEPLOY_AUTO_ADD_TARGET:-${BERRYKEEP_RENDEZVOUS_AUTO_ADD_TARGET:-true}}"
...
Environment overrides:
  BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_DIR
  BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_BINARY
  BERRYKEEP_RENDEZVOUS_DEPLOY_LEGACY_REMOTE_BINARY
  BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_WORKDIR
  BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_PIDFILE
  BERRYKEEP_RENDEZVOUS_DEPLOY_LEGACY_REMOTE_PIDFILE
  BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_LOGFILE
  BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_START_CMD
  BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_MATCH_PATTERN
  BERRYKEEP_RENDEZVOUS_DEPLOY_STOP_TIMEOUT_SECS
  BERRYKEEP_RENDEZVOUS_DEPLOY_FORCE_KILL=true|false
  BERRYKEEP_RENDEZVOUS_DEPLOY_AUTO_ADD_TARGET=true|false
  BERRYKEEP_RENDEZVOUS_DEPLOY_TARGET

Compatibility aliases still honored:
  BERRYKEEP_RENDEZVOUS_REMOTE_DIR
  BERRYKEEP_RENDEZVOUS_REMOTE_BINARY
  BERRYKEEP_RENDEZVOUS_REMOTE_WORKDIR
  BERRYKEEP_RENDEZVOUS_REMOTE_PIDFILE
  BERRYKEEP_RENDEZVOUS_REMOTE_LOGFILE
  BERRYKEEP_RENDEZVOUS_REMOTE_START_CMD
  BERRYKEEP_RENDEZVOUS_REMOTE_MATCH_PATTERN
  BERRYKEEP_RENDEZVOUS_STOP_TIMEOUT_SECS
  BERRYKEEP_RENDEZVOUS_FORCE_KILL=true|false
  BERRYKEEP_RENDEZVOUS_AUTO_ADD_TARGET=true|false
  BERRYKEEP_RENDEZVOUS_TARGET
...
Notes:
  ...
  Configure BERRYKEEP_RENDEZVOUS_PEER_URLS in the remote environment file when
...
warn_legacy_env_alias_if_used() {
  local canonical="$1"
  local legacy="$2"

  if [[ -z "${!canonical:-}" && -n "${!legacy:-}" ]]; then
    log "warning: ${legacy} is a compatibility alias; prefer ${canonical}"
  fi
}

warn_legacy_env_aliases() {
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_TARGET BERRYKEEP_RENDEZVOUS_TARGET
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_DIR BERRYKEEP_RENDEZVOUS_REMOTE_DIR
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_BINARY BERRYKEEP_RENDEZVOUS_REMOTE_BINARY
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_WORKDIR BERRYKEEP_RENDEZVOUS_REMOTE_WORKDIR
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_PIDFILE BERRYKEEP_RENDEZVOUS_REMOTE_PIDFILE
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_LOGFILE BERRYKEEP_RENDEZVOUS_REMOTE_LOGFILE
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_START_CMD BERRYKEEP_RENDEZVOUS_REMOTE_START_CMD
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_REMOTE_MATCH_PATTERN BERRYKEEP_RENDEZVOUS_REMOTE_MATCH_PATTERN
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_STOP_TIMEOUT_SECS BERRYKEEP_RENDEZVOUS_STOP_TIMEOUT_SECS
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_FORCE_KILL BERRYKEEP_RENDEZVOUS_FORCE_KILL
  warn_legacy_env_alias_if_used BERRYKEEP_RENDEZVOUS_DEPLOY_AUTO_ADD_TARGET BERRYKEEP_RENDEZVOUS_AUTO_ADD_TARGET
}
