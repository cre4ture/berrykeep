...
Environment overrides:
  ...
  IRONMESH_RENDEZVOUS_DEPLOY_STOP_TIMEOUT_SECS
  IRONMESH_RENDEZVOUS_DEPLOY_FORCE_KILL=true|false
  IRONMESH_RENDEZVOUS_DEPLOY_AUTO_ADD_TARGET=true|false
  IRONMESH_RENDEZVOUS_DEPLOY_TARGET
...
warn_legacy_env_aliases() {
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_TARGET IRONMESH_RENDEZVOUS_TARGET
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_REMOTE_DIR IRONMESH_RENDEZVOUS_REMOTE_DIR
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_REMOTE_BINARY IRONMESH_RENDEZVOUS_REMOTE_BINARY
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_REMOTE_WORKDIR IRONMESH_RENDEZVOUS_REMOTE_WORKDIR
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_REMOTE_PIDFILE IRONMESH_RENDEZVOUS_REMOTE_PIDFILE
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_REMOTE_LOGFILE IRONMESH_RENDEZVOUS_REMOTE_LOGFILE
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_REMOTE_START_CMD IRONMESH_RENDEZVOUS_REMOTE_START_CMD
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_REMOTE_MATCH_PATTERN IRONMESH_RENDEZVOUS_REMOTE_MATCH_PATTERN
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_STOP_TIMEOUT_SECS IRONMESH_RENDEZVOUS_STOP_TIMEOUT_SECS
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_FORCE_KILL IRONMESH_RENDEZVOUS_FORCE_KILL
  warn_legacy_env_alias_if_used IRONMESH_RENDEZVOUS_DEPLOY_AUTO_ADD_TARGET IRONMESH_RENDEZVOUS_AUTO_ADD_TARGET
}
