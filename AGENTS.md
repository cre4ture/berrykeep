...
Repository skills live in [.agents/skills/](.agents/skills/). Agents that do not discover this directory natively must read the relevant `SKILL.md` before performing a corresponding task.
