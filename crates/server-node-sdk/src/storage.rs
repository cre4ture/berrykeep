...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub(crate) enum HostDependencyStatus {
    Ready,
    Missing,
    Builtin,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct HostDependencyCheck {
    pub id: String,
    pub feature: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct HostDependencyReport {
    pub host_os: String,
    pub generated_at_unix: u64,
...
impl MediaToolPaths {
    fn host_dependency_report(&self) -> HostDependencyReport {
