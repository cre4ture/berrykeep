...
@MainActor
final class BerryKeepOriginalShareCoordinator {
    private let configuration: BerryKeepBundleConfiguration
    ...
    init(
        configuration: BerryKeepBundleConfiguration = BerryKeepBundleConfiguration(bundle: .main),
        ...
        guard let appGroupIdentifier = configuration.appGroupIdentifier else {
            throw BerryKeepOriginalShareCoordinatorError.appGroupUnavailable
        }
    ...
    private func userVisibleURL(for capability: AppleOriginalShareCapability) async throws -> URL {
        ...
        guard registration.state.isRegistered else {
            throw BerryKeepOriginalShareCoordinatorError.fileProviderUnavailable(
    ...
    private func presentActivityController(
        ...
        guard presenter.presentedViewController == nil else {
            throw BerryKeepOriginalShareCoordinatorError.presentationUnavailable
        }
...
enum BerryKeepOriginalShareCoordinatorError: LocalizedError {
...
func berrykeepIosEmbeddedWebURL(
    _ url: URL,
