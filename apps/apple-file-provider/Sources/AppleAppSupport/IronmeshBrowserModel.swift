...
struct IronmeshConnectionDraft: Codable, Equatable, Sendable {
    var deviceLabel: String
    var directConnectionInput: String
    var bootstrapInput: String
    var serverCAPem: String
    var clientIdentityJSON: String
    ...
    var effectiveConnectionInput: String {
    ...
    var normalizedConnectionInput: String? {
        connectionConfiguration?.normalizedConnectionInput
    }

    var directConnectionURL: URL? {
        guard let directConnectionInput = directConnectionInput.nilIfBlank else {
            return nil
        }

        let normalized = AppleConnectionConfiguration(connectionInput: directConnectionInput).normalizedConnectionInput
    ...
    mutating func applyScannedCode(_ scannedValue: String) -> Bool {
    ...
    static func scannedConnectionPayload(from scannedValue: String) -> String? {
    ...
    static func looksLikeBootstrap(_ value: String) -> Bool {
