...
final class BerryKeepWorkingSetSignalCoordinator: @unchecked Sendable {
    private let configuration: BerryKeepBundleConfiguration
    private let profileStore: AppleSyncProfileStore
    private let environment: any BerryKeepSyncEnvironmentObserving
    ...
    init(
        configuration: BerryKeepBundleConfiguration,
        profileStore: AppleSyncProfileStore? = nil,
        environment: any BerryKeepSyncEnvironmentObserving = BerryKeepLiveSyncEnvironment.shared,
