...
extension BerryKeepFileProviderExtensionHost {
    public func item(
    ...
    private func validate(
        ...
        let providedVersion = BerryKeepFileProviderItem(
            bridgeItem: item,
    ...
    public func enumerator(
        ...
        _ = request
        return BerryKeepFileProviderEnumerator(containerIdentifier: containerItemIdentifier, service: service)
    }
}
