...
import io.berrykeep.android.ui.FolderSyncHistoryState
import io.berrykeep.android.ui.SyncScreenActions
import io.berrykeep.android.ui.SyncUiState
            ...
            Button(
                onClick = {
                    val updatedPolicy = FolderSyncNetworkPolicy(
                        ...
                        allowOtherConnections = allowOtherConnections,
                        allowRoaming = allowRoaming,
                        allowedWifiSsids = io.berrykeep.android.data.parseAllowedWifiSsidsInput(
                            allowedWifiSsids,
                        ),
                    ).normalized()
