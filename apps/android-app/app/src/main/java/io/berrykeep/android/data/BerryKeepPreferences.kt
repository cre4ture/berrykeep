...
object BerryKeepPreferences {
    ...
    fun getThemeAccentColor(context: Context): String {
        ...
        return normalizeBerryKeepAccentColorHex(raw) ?: DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX
    }
    ...
    fun setThemeAccentColor(
        ...
        val normalized = normalizeBerryKeepAccentColorHex(colorHex) ?: DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX
        writeAppPreference(
            context,
            PREF_THEME_ACCENT_COLOR,
            normalized.takeUnless { it == DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX },
        )
    }
}
