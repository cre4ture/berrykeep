...
import io.berrykeep.android.PrivateWebServiceActivity
import io.berrykeep.android.share.OriginalShareCoordinator
...
private const val EMBEDDED_WEB_UI_SESSION_HEADER = "X-BerryKeep-Web-Ui-Session"
...
private const val ANDROID_SHARE_JAVASCRIPT_OBJECT = "BerryKeepAndroidShare"
private const val ANDROID_UI_JAVASCRIPT_OBJECT = "BerryKeepAndroidUi"
private const val GALLERY_MAP_FULLSCREEN_MESSAGE_TYPE = "gallery-map-fullscreen"
private const val GALLERY_MAP_FULLSCREEN_EXIT_EVENT = "berrykeep:gallery-map-exit-fullscreen"
private val androidShareExecutor = Executors.newSingleThreadExecutor { runnable ->
    Thread(runnable, "berrykeep-original-share").apply { isDaemon = true }
}

@Composable
fun BerryKeepEmbeddedWebUi(
...
internal fun embeddedWebUiUrl(
    ...
    val nativeAccent = normalizeBerryKeepAccentColorHex(accentColorHex)
