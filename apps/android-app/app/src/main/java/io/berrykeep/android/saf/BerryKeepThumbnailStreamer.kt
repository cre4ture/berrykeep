...
internal enum class BerryKeepThumbnailProfile(
...
internal fun thumbnailProfileForRequestedSize(
    widthPx: Int,
    heightPx: Int,
): BerryKeepThumbnailProfile =
    if (maxOf(widthPx, heightPx) >= MOBILE_VIEWER_THUMBNAIL_MAX_DIMENSION_PX) {
        BerryKeepThumbnailProfile.MOBILE_VIEWER
    } else {
        BerryKeepThumbnailProfile.GRID
    }

internal interface BerryKeepThumbnailStreamDataSource {
...
internal class BerryKeepRepositoryThumbnailDataSource(
    private val repository: BerryKeepRepository,
) : BerryKeepThumbnailStreamDataSource {
...
internal class BerryKeepThumbnailStreamer(
    private val dataSource: BerryKeepThumbnailStreamDataSource,
) {
    suspend fun streamTo(
        ...
        serverCaPem: String? = null,
        clientIdentityJson: String? = null,
        profile: BerryKeepThumbnailProfile = BerryKeepThumbnailProfile.GRID,
    ) {
    ...
    private fun applyProfile(
        relativeUrl: String,
        profile: BerryKeepThumbnailProfile,
    ): String {
