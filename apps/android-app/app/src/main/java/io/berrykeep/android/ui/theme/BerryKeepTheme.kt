package io.berrykeep.android.ui.theme
...
const val DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX = "#14B8A6"

val BERRYKEEP_ACCENT_COLOR_SWATCHES = listOf(
    DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX,
    "#2563EB",
    "#7C3AED",
    "#DB2777",
    "#EA580C",
...
private val DefaultAccentColor = parseColorHex(DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX)
...
fun normalizeBerryKeepAccentColorHex(value: String?): String? {
...
fun parseBerryKeepAccentColorOrDefault(value: String?): Color =
    normalizeBerryKeepAccentColorHex(value)
        ?.let(::parseColorHex)
        ?: DefaultAccentColor

fun berrykeepAccentColorToHex(color: Color): String {
...
fun BerryKeepTheme(
    ...
    accentColorHex: String = DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX,
    content: @Composable () -> Unit,
) {
    MaterialTheme(
        colorScheme = createBerryKeepColorScheme(
            darkTheme = darkTheme,
...
private fun createBerryKeepColorScheme(
    darkTheme: Boolean,
    accentColorHex: String,
): ColorScheme {
    val accent = parseBerryKeepAccentColorOrDefault(accentColorHex)
...
private fun parseColorHex(hex: String): Color {
    val normalized = normalizeBerryKeepAccentColorHex(hex) ?: DEFAULT_BERRYKEEP_ACCENT_COLOR_HEX
