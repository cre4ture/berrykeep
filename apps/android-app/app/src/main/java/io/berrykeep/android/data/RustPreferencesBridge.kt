...
object RustPreferencesBridge {
    ...
    fun updateDeviceAuthBootstrapJson(bootstrapJson: String) {
        ...
        val current = BerryKeepPreferences.getDeviceAuthState(context)
    ...
    fun clearCacheDirectory() {
        val context = appContext ?: error("RustPreferencesBridge is not initialized")
        File(context.cacheDir, "berrykeep-client").deleteRecursively()
    }
        ...
        AppConnectionStatusStore(
            ...
            persistence = object : AppConnectionStatusPersistence {
                override suspend fun load(): AppConnectionStatus =
                    BerryKeepPreferences.getAppConnectionStatus(context)

                override suspend fun save(status: AppConnectionStatus) {
                    BerryKeepPreferences.setAppConnectionStatus(context, status)
                }
            },
