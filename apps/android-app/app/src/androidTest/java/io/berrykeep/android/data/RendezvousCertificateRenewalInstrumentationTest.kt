...
import io.berrykeep.android.ui.enrollmentVerificationSuccessDetail
...
class RendezvousCertificateRenewalInstrumentationTest {
    ...
    fun setUp() {
        ...
        BerryKeepPreferences.clearDeviceAuthState(appContext)
    ...
    fun storeIndex_renewsExpiredRendezvousCertificate_andPersistsUpdatedIdentity() {
        ...
        BerryKeepPreferences.setDeviceAuthState(appContext, seededState)

        val authBeforeRequest = BerryKeepPreferences.getDeviceAuthState(appContext)
        ...
        val persisted = BerryKeepPreferences.getDeviceAuthState(appContext)
        assertNotEquals(
    ...
    fun verifyEnrollmentAccess_reportsTheCompletedSignedRequestTimingAndRoute() = runBlocking {
        ...
        val verification = BerryKeepRepository().verifyEnrollmentAccess(authState)
    ...
    fun mainViewModel_reloadsPersistedIdentityBeforeBuildingClientRequests() = runBlocking {
        ...
        BerryKeepPreferences.setDeviceAuthState(appContext, expiredState)
        ...
        BerryKeepPreferences.setDeviceAuthState(appContext, renewedState)
