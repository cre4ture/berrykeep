...
import io.berrykeep.android.data.RustClientTestBridge
import io.berrykeep.android.data.RustPreferencesBridge
import io.berrykeep.android.share.OriginalShareCapabilityStore
import io.berrykeep.android.share.OriginalShareRequest
import io.berrykeep.android.share.originalShareDocumentUri
...
class BerryKeepDocumentsProviderInstrumentationTest {
    ...
    private fun configureProviderDownloadScenario(): ProviderDownloadScenario {
        ...
        BerryKeepPreferences.setDeviceAuthState(
            appContext,
            DeviceAuthState(
