...
class PrivateWebServiceInstrumentationTest {
    ...
    fun inAppPrivateServiceRedeemsTheLaunchAndRendersTheAuthenticatedPage() {
        LocalPrivateServiceServer().use { server ->
            ...
            val launchUrl = "http://home-nas-test.localhost:${server.port}/_berrykeep/open?token=test-token"
    ...
    private class LocalPrivateServiceServer : Closeable {
        ...
        fun openRequestCount(): Int = requests.count { it.path == "/_berrykeep/open" }
    ...
    private companion object {
        const val SESSION_COOKIE = "berrykeep_service_gateway_session"
