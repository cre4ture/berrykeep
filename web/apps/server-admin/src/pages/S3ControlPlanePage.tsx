...
function accessKeyStatusColor(accessKey: S3AccessKeyView): string {
  return accessKey.revoked_at_unix ? "red" : berrykeepPrimaryColor;
}
...
export function S3ControlPlanePage() {
  ...
  return (
    <Stack gap="lg">
      ...
      {latestCreatedAccessKey ? (
        <Alert color={berrykeepPrimaryColor} title="New S3 access key issued">
          <Stack gap="sm">
            <Text c="dimmed">
          ...
          <Card withBorder radius="md" padding="lg">
            <Stack gap="md">
              <Group justify="space-between">
                ...
                <Badge color={status?.tls_enabled ? berrykeepPrimaryColor : "gray"} variant="light">
                ...
                {bucketRows.length > 0 ? (
                  bucketRows.map((bucket) => (
                    <Table.Tr key={bucket.bucket_name}>
                      ...
                      <Table.Td>
                        <Badge color={bucket.versioning_status === "enabled" ? berrykeepPrimaryColor : "gray"} variant="light">
